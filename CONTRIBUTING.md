# Contributing to CoreJS

We would love for you to contribute to CoreJS and help make it even better than it is today!
...
* You can create a question on [StackOverflow](https://stackoverflow.com/questions/tagged/corejs) where the questions should be tagged with tag `corejs`.
* You can ask on [Slack](https://join.slack.com/t/corejs/shared_invite/zt-gej3gc00-hR~L~DqGUJ7qOpGy4SSq3g)
* You can create issue on [github](https://github.com/ialopezg/corejs/issues)
...
please contact me within my [email](https://github.com/ialopezg/corejs/blob/master/package.json#L10).

## <a name="issue"></a> Found a Bug?

If you find a bug in the source code, you can help us by [submitting an issue](#submit-issue) to our
[GitHub Repository](https://github.com/ialopezg/corejs).
...
You can file new issues by filling out our [new issue form](https://github.com/ialopezg/corejs/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/ialopezg/corejs/pulls) for an open or closed PR
...
* Run the full CoreJS test suite, as described in the [developer documentation](DEVELOPER.md), and ensure that all tests pass.
...
* In GitHub, send a pull request to `corejs:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the CoreJS test suites to ensure tests are still passing.
...
This new feature change bahviour of CoreJS to allow use new magic decorator...
...
Thank you to all the people who have already contributed to CoreJS!
